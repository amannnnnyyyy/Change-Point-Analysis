...
def change_point_analysis(data):
    ...
    results_df.to_csv('../docs/change_points_results.csv', index=False)

    print("Detected Change Points and Significant Change Points have been saved to 'docs/change_points_results.csv'.")
